    ...
    <div class="sign-up">
      ...
      <span>
       ...
       <span>
        ...
        <div class="agree">
	        <p style="display: flex; justify-content: space-between; width:50%;"><input id="agree1" type="checkbox" style="width:15px;" required> 
	        	<a onClick="openPopup()">이용약관 동의</a> 
	        	<span class="fil">(필수)</span>
	        </p>
	       <p style="display: flex; justify-content: space-between; width:70%;"><input id="agree2" type="checkbox" style="width:15px;" required> 
