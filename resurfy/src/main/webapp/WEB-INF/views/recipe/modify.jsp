			...
			<c:if test="${ing.ingreType eq '주재료'}">
              ...
              <li id="liIngredient_1_1">
               <select class="form-select" id="ingredient_type" control-id="ControlID-11">
                <option>재료별</option>
                <option value="23" <c:if test ="${ing.ingreType eq '주재료'}">selected="selected"</c:if>> 주재료</option>
                <option value="28" <c:if test ="${ing.ingreType eq '부재료'}">selected="selected"</c:if>>부재료</option>
                <option value="24" <c:if test ="${ing.ingreType eq '양념'}">selected="selected"</c:if>>양념</option>
              </select>		
